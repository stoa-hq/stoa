...
import type { ApiResponse, Order, PaginationParams } from '$lib/types';

const BASE = '/admin/orders';

export const ordersApi = {
	list: (params: PaginationParams & { status?: string; customer_id?: string } = {}) => {
		...
		if (params.customer_id) q.set('filter[customer_id]', params.customer_id);
